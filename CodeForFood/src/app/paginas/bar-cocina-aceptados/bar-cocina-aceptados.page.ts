...
@Component({
  selector: 'app-bar-cocina-aceptados',
  templateUrl: './bar-cocina-aceptados.page.html',
  styleUrls: ['./bar-cocina-aceptados.page.scss'],
})
export class BarCocinaAceptadosPage implements OnInit {
